          ...
          <>
            ...
            >
              ...
              <div className="mt-auto space-y-3 pt-6">
                ...
                <a href={`tel:${site.phone.dial}`} onClick={() => trackEvent('phone_click', { source: 'mobile_drawer' })} className="flex items-center justify-center gap-2 font-bold text-charcoal">
