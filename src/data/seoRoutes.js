...
export const staticRoutes = [
  ...
  },
  {
    ...
    description:
      'ספק ההסעדה המוביל למפעלים בדרום: ארוחות חמות לעובדים כל יום, בכשרות ובבקרת בטיחות מזון. עשרות מפעלים בקרית גת, אשקלון, באר שבע והסביבה כבר איתנו.',
    lastmod: '2026-07-13',
  },
  {
    path: '/friday',
    ...
    description:
      'מכירת השישי הגדולה בדרום, כל יום שישי בקרית גת. עוף בזיתים, חריימה וחלות מהתנור. מזמינים עד רביעי בערב ואוספים בשישי.',
    lastmod: '2026-07-13',
  },
  {
    path: '/services',
    ...
    description:
      'מטבח אחד בקרית גת, ארבעה שירותים: הסעדה למפעלים, מכירת שישי, קייטרינג לאירועים וארוחות מסובסדות לעובדים.',
    lastmod: '2026-07-13',
  },
  {
    path: '/gallery',
    title: `גלריה · ${BRAND}`,
    description: 'הצצה למנות, לאירועים ולמטבח של קייטרינג אלגריה בקרית גת.',
    lastmod: '2026-07-13',
  },
  {
    path: '/blog',
    title: `הבלוג של אלגריה · טיפים ומדריכי קייטרינג`,
    description:
      'מדריכים וטיפים על קייטרינג, הסעדה ותכנון כמויות לאירוע, מהניסיון של המטבח שלנו בדרום.',
    lastmod: '2026-07-14',
  },
  {
    path: '/testimonials',
  ...
  },
  {
    path: '/about',
    title: `אודות · ${BRAND}`,
    description: 'הסיפור של אלגריה: 25 שנה ויותר שאנחנו מבשלים לדרום, מהמטבח של סבתא ועד אלפי מנות ביום.',
    lastmod: '2026-07-13',
  },
  {
    path: '/faq',
  ...
  },
  {
    path: '/contact',
    title: `צור קשר · ${BRAND}`,
    description: 'וואטסאפ, טלפון ושעות פעילות. הצעת מחיר כתובה חוזרת לרוב עוד באותו יום.',
    lastmod: '2026-07-13',
  },
  {
    path: '/accessibility',
